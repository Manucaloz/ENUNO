...
async def protected_resource(request):
    ...
    GET: Retorna un mensaje simple indicando que el recurso está protegido.

    Respuesta:
        - 200 OK: Mensaje del recurso protegido.
    """
    return JsonResponse({"message": "Este es un recurso protegido"})
